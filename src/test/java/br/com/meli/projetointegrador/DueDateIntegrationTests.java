...
public class DueDateIntegrationTests {
    ...
    void getBatchStockByDueDate() throws Exception {
        ...
        String checkBatchStockDueDate = getCheckBatchStockDueDate("64", "3",status().isOk());
    ...
    void getBatchStockByDueDateWithCategory() throws Exception {
        ...
        String checkBatchStockDueDateWithCategory1 = getCheckBatchStockDueDateWithCategory("95", "FRESH", "asc", status().isOk());
        String checkBatchStockDueDateWithCategory2 = getCheckBatchStockDueDateWithCategory("95", "FRESH", "desc", status().isOk());
